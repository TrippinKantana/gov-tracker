...
router.post('/email', [
    (0, express_validator_1.body)('recipients').isArray({ min: 1 }).withMessage('Recipients array is required'),
    ...
    (0, express_validator_1.body)('assetName').notEmpty().withMessage('Asset name is required'),
    handleValidation
], async (req, res) => {
    try {
...
router.post('/test-send', [
    (0, express_validator_1.body)('recipient').isEmail().withMessage('Valid recipient email is required'),
    handleValidation
], async (req, res) => {
    try {
