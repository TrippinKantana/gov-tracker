...
router.get('/global', [
    ...
    try {
        ...
        try {
            ...
            const vehicleMatches = mockVehicles.filter(vehicle => vehicle.plateNumber.toLowerCase().includes(query) ||
        ...
        try {
            ...
            const equipmentMatches = mockEquipment.filter(equipment => equipment.name.toLowerCase().includes(query) ||
        ...
        try {
            ...
            const facilityMatches = mockFacilities.filter(facility => facility.name.toLowerCase().includes(query) ||
        ...
        try {
            ...
            const employeeMatches = mockEmployees.filter(employee => employee.name.toLowerCase().includes(query) ||
...
router.get('/suggestions', [
    ...
    try {
        ...
        if (q) {
            ...
            filteredSuggestions = suggestions.filter(suggestion => suggestion.toLowerCase().includes(query));
        }
        return res.json({
            success: true,
