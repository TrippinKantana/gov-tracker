...
router.get('/',
  [
    ...
    query('type').optional().isIn(['laptop', 'desktop', 'tablet', 'phone', 'printer', 'projector', 'server', 'radio', 'camera']),
    query('status').optional().isIn(['active', 'available', 'maintenance', 'retired', 'lost']),
...
router.post('/',
  [
    ...
    body('type').isIn(['laptop', 'desktop', 'tablet', 'phone', 'printer', 'projector', 'server', 'radio', 'camera']),
    body('brand').notEmpty().isLength({ min: 1, max: 100 }),
    body('model').notEmpty().isLength({ min: 1, max: 100 }),
    body('serialNumber').notEmpty().isLength({ min: 1, max: 100 }),
    body('department').notEmpty().isLength({ min: 1, max: 255 }),
    body('status').isIn(['active', 'available', 'maintenance', 'retired', 'lost']),
    ...
    body('location').notEmpty().isLength({ min: 1, max: 255 }),
...
router.put('/:id',
  [
    ...
    body('type').optional().isIn(['laptop', 'desktop', 'tablet', 'phone', 'printer', 'projector', 'server', 'radio', 'camera']),
    body('brand').optional().isLength({ min: 1, max: 100 }),
    body('model').optional().isLength({ min: 1, max: 100 }),
    body('serialNumber').optional().isLength({ min: 1, max: 100 }),
    body('department').optional().isLength({ min: 1, max: 255 }),
    body('status').optional().isIn(['active', 'available', 'maintenance', 'retired', 'lost']),
